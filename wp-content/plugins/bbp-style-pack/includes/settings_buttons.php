...
function bsp_style_settings_buttons () {
	...
	<table>
		<tr>
			<td>
				<p>
					<?php _e('This section allows you to add up to 3 buttons - a create topic button, a subscribe button and a profile button, style and display them in any order', 'bbp-style-pack'); ?> 
				</p>
			</td>
...
<!-- PROFILE BUTTON  -->	
	...
	<!-- BUTTON STYLING -->					
		...
		<tr>
			<td colspan=2>
				<?php _e('You can style the button below, use an existing class from your theme, or create a button class (see help further down)', 'bbp-style-pack'); ?>
			</td>
			<?php
		...
		<tr>
			<td colspan = "2">
				<?php _e ('If you wish to change the default order, do this here' , 'bbp-style-pack' ) ; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="vertical-align:top">
				...
				<label class="description">
					<?php _e( 'Enter the order ie a number from 1 to 3', 'bbp-style-pack' ); ?>
				</label>
				</br>
			</td>
		</tr>
